...
<body bgcolor="#000000">
 ...
 <table width="100%" height="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <td colspan=2 style="text-align:right"><text style="font-size:14px;color:#<?php echo( substr ( md5( $_SERVER['SERVER_ADDR'] ),0,6) ) ; ?>;"> ◉ </text><text style="font-size:14px;color:#FFFFFF;">Proudly served by OpenShift</text></td>
  </tr>
 </table>
</body>
</html>
